...
function readFilesSync(dir) {
  ...
  sortedChangelogs.forEach((file) => {
    const filePath = path.join(
      '/Users/pauljaffre/cypress/cypress-documentation/docs/guides/references/_changelogs',
      file
    )
    ...
    fs.readFile(filePath, 'utf8', (err, data) => {
      ...
      fs.appendFile(
        '/Users/pauljaffre/cypress/cypress-documentation/docs/guides/references/changelog.mdx',
        data.toString() + '\n',
        function (err) {
