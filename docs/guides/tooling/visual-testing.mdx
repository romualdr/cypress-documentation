...
<DocsImage src="/img/guides/visual-testing/completed-test.gif" alt="Passing Cypress functional test" />
...
<DocsImage src="/img/guides/visual-testing/completed-item.png" alt="Completed item style" />
