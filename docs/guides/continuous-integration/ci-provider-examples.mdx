...
Check out the full <Icon
  name="github"
  inline="true"
  callout="RWA CircleCI configuration"
...
Check out the full <Icon
  name="github"
  inline="true"
  callout="RWA GitHub Actions configuration"
...
Check out the full <Icon
  name="github"
  inline="true"
  callout="RWA BitBucket Pipelines configuration"
  url="https://github.com/cypress-io/cypress-realworld-app/blob/develop/bitbucket-pipelines.yml"
/>.
...
Check out the full <Icon
  name="github"
  inline="true"
  callout="RWA GitLab CI configuration"
  url="https://github.com/cypress-io/cypress-realworld-app/blob/develop/gitlab-ci.yml"
/>.
...
Check out the full <Icon
  name="github"
  inline="true"
  callout="RWA AWS CodeBuild configuration"
  url="https://github.com/cypress-io/cypress-realworld-app/blob/develop/buildspec.yml"
/>.
