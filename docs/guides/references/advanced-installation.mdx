...
2. Find the commit that you would like to install the pre-release version of.
   ...
   <DocsImage src="/img/guides/install/develop-commit-comment-link.png" alt="Example of a commit for which pre-releases are available. Comment link highlighted in red." />
...
<DocsImage src="/img/guides/install/vcxsrv-extra-settings.png" alt="Disable access control in vcxsrv" />
...
<DocsImage src="/img/guides/install/windows-firewall-disable-vcxsrv.png" alt="Add rule to allow connections for vcxsrv" />
...
<DocsImage src="/img/guides/install/rule-application-selection.png" alt="Select inbound rule application cases for vcxsrv" />
