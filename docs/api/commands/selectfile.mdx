...
<DocsImage src="/img/api/selectfile/selectfile-command-log.png" alt="Command log for selectFile" />

When clicking on `selectFile` within the command log, the console outputs the
following:

<DocsImage src="/img/api/selectfile/selectfile-console.png" alt="console.log for selectFile" />
